        ...
        webpack: {
            ...
            resolve: {
                alias: {
                    ...
                    //TODO: provide testing version of app modules which will provide predefined settings
                    '@app': path.join(__dirname, './helpers/app'),
                    '@models': path.join(__dirname, '../src/models'),
                    '@ipc': path.join(__dirname, '../src/modules/ipc'),
                    '@src': path.join(__dirname, '../src'),
                    '@testHelpers': path.join(__dirname, './helpers')
                },
                extensions: ['.js']
            }
        },
