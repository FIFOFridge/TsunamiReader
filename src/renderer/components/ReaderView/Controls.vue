<template>
    <div class="controls-container">
        ...
        <div class="right-container">
            <!-- <div class="search-container" v-on:click="$emit('clicked-search-container')">
                <input id="book-search">

                Search
                <button id='search-button' v-on:click="$emit('clicked-search')">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
export default {
    ...
    data: function() {
        return {
            drawerActionVisibility: 'visible'
        }
    }, 
    watch: {
        isDrawerOpen: function(value) {
            if(value) {
                this.drawerActionVisibility = 'hidden'
            }
            else {
                this.drawerActionVisibility = 'visible'
            }
        }
    }
}
